...
d_sets = ['yt_bb_classification_validation', 'yt_bb_classification_train']

# Column names for detection CSV files
col_names = ['youtube_id', 'timestamp_ms','class_id','class_name','object_presence']
...
def dl_and_cut(vid, data, d_set_dir):
    ...
    if os.path.exists(video_path):
        ...
        for index, row in data.iterrows():
            ...
            frame_path = class_dir+'/{:s}_{:0>2}_{:0>4}_{:0>8}.jpg'.format(
                    youtube_id, cls_id, ts_)
